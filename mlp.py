...
class NeuralNetwork(nn.Module):
    def __init__(self):
        ...
        # Aplatizam imaginea 100x100x3 intr-un vector de lungime 30000
        self.flatten = nn.Flatten()

        # Primul strat complet conectat + normalizare + dropout
        self.fc1 = nn.Linear(100*100*3, 1024) # 30000 canale in, 1024 canale out
        self.bn1 = nn.BatchNorm1d(1024) # normalizarea outputului
        self.dropout1 = nn.Dropout(0.4) # dropout pe output

        # Al doilea strat complet conectat + normalizare + dropout
        self.fc2 = nn.Linear(1024, 1024)
        self.bn2 = nn.BatchNorm1d(1024)
        self.dropout2 = nn.Dropout(0.4)

        # Al treilea strat complet conectat + normalizare + dropout
